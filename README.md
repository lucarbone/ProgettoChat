...
Durante la scrittura della parte server, nella parte della lista dei client connessi, abbiamo avuto un paio di problemi, per esempio la lista del client non andava correttamente e non mostrava il numero di utenti connessi corretto, oppure non rimuoveva il client quando si disconnetteva.
